...
<footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
            ...
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    ...
                    <li><a href="https://github.com/abhishekrithik" className="hover:text-green-600 transition">Github</a></li>
                    <li><a href="https://my3-dportfolio-vert.vercel.app/" className="hover:text-green-600 transition">Portfolio</a></li>
                    <li><a href="/" className="hover:text-green-600 transition">Affiliate</a></li>
                    <li><a href="https://www.instagram.com/abhishek_rithik?igsh=Ymt1bXc4ZDc0ZDRy&utm_source=qr" className="hover:text-green-600 transition">Instagram</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    ...
                    <li><a href="https://mern-blog-saiabhi.onrender.com/" className="hover:text-green-600 transition">Blogs</a></li>
                    <li><a href="https://www.linkedin.com/in/abhishek-gnanasekar/" className="hover:text-green-600 transition">Linkedin</a></li>
                    <li><a href="https://github.com/abhishekrithik" className="hover:text-green-600 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></a></li>
                    <li><a href="https://my3-dportfolio-vert.vercel.app/" className="hover:text-green-600 transition">About</a></li>
                </ul>
            </div>
            <div>
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
            <p className="max-w-60">Making every project unique.</p>
            <div className="flex items-center gap-4 mt-3">
                <a href="https://my3-dportfolio-vert.vercel.app/" target="_blank" rel="noreferrer">
                ...
                <a href="https://www.linkedin.com/in/abhishek-gnanasekar/" target="_blank" rel="noreferrer">
                ...
                <a href="https://www.instagram.com/abhishek_rithik?igsh=Ymt1bXc4ZDc0ZDRy&utm_source=qr" target="_blank" rel="noreferrer">
            ...
            <p className="mt-3 text-center">© 2025 Abhishek's Resume Builder</p>
        </div>
    </footer>
